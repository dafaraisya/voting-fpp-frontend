...
export default {
  ...
  methods: {
    login() {
      axios
        .post("http://pemira.fppundip.com:3000/api/v1/login", this.authentication)
        .then((response) => {
...
.home-voting {
  background-image: linear-gradient(
    ...
    url("https://drive.google.com/uc?export=download&id=1rrOCmnSJhaSNb9re11XtNZBaRroU8p8x");
