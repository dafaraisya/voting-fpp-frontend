...
export default {
  ...
  methods: {
    ...
    del(id) {
      axios
        .delete("http://pemira.fppundip.com:3000/api/v1/participant/" + id)
    ...
    search() {
      ...
      axios
        .get(
          "http://pemira.fppundip.com:3000/api/v1/participant/search/" +
            this.keyword
        )
        .then((res) => {
  ...
  mounted() {
    axios
      .get(
        "http://pemira.fppundip.com:3000/api/v1/participant/page/" +
