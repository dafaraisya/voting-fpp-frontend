...
#timeline {
  ...
  background-image: linear-gradient(
    ...
    url("https://drive.google.com/uc?export=download&id=1TZy9zVZ22dEM-JLIQLuALHFw8GaXi0LM");
...
#announcement {
  ...
  background-image: linear-gradient(
    ...
    url("https://drive.google.com/uc?export=download&id=16tQN5_fWt3NdhxRsArSrfkdNUQEa2BI0");
  background-repeat: no-repeat;
  background-size: cover;
  background-position: center;
}
